        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <option value="2" @if($contact->age === 2 ) selected @endif>20歳から29歳</option>
                    <option value="3" @if($contact->age === 3 ) selected @endif>30歳から39歳</option>
                    <option value="4" @if($contact->age === 4 ) selected @endif>40歳から49歳</option>
                    <option value="5" @if($contact->age === 5 ) selected @endif>50歳から59歳</option>
